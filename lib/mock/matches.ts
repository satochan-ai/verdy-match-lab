...
export const matches: Match[] = [
  ...
  },
  {
    ...
    actualLineups: {
      ...
      away: {
        ...
        starters: {
          GK: ["71 権田 修一"],
          DF: ["17 髙橋 壱晟", "4 山川 哲史", "3 マテウス トゥーレル", "15 ジエゴ"],
          MF: ["24 酒井 高徳", "7 井手口 陽介", "5 郷家 友太"],
          FW: ["2 飯野 七聖", "29 小松 蓮", "41 永戸 勝也"],
        },
        bench: {
          GK: ["1 前川 黛也"],
  ...
  },
  {
    ...
    matchNotes: [
      "7連戦の最後となるホーム千葉戦。東京Vは直前の滋賀戦で若手を中心に起用しており、リーグ戦では主力を戻す形を予想する。",
      "千葉は相手のシステムに応じて最終ラインの形を変える可能性があり、今回は東京Vの3バックに対して4-4-2を採用するケースをひとつの仮説として想定した。",
      "4-4-2で入る場合、東京Vは3バックで相手2トップに対して数的優位を作りやすい。その優位を使って後方から前進し、両WBと2シャドーを高い位置で使えるかがポイントになる。",
      "一方で、両WBが高い位置を取った後のボールロストには注意したい。千葉が2トップを残す形なら、奪われた直後の縦への展開を早い段階で止められるかが重要になる。",
      "また、この試合は7連戦の最終戦でもある。後半に入ってからの運動量と交代選手の働きも、試合の流れを左右する要素になりそうだ。",
    ],
    focusPoints: [
      "東京Vの3バック vs 千葉の前線：千葉が4-4-2を採用した場合、東京Vは後方で3対2を作れる可能性がある。その数的優位を前進につなげられるか、それとも千葉の前線からの圧力に出口を消されるかが序盤の注目点。",
      "内田・溝口の両WB：東京Vが主導権を握るには、内田と溝口がどこまで高い位置を取れるかが重要になる。千葉の両サイドを押し込めれば攻撃時の厚みが増す一方、低い位置に固定されると5バック気味になり、前線の人数が不足しやすい。",
      "7連戦最後の後半戦：千葉戦は7連戦の最後。直前の滋賀戦では若手中心のターンオーバーを行ったが、チーム全体としては連戦の最終戦となる。60〜70分以降の運動量、交代カード、試合終盤でも強度を維持できるかに注目したい。",
    ],
    strategies: [
      {
        orderNo: 1,
        title: "千葉の2トップ脇から前進する",
        description:
          "千葉が4-4-2で入る場合、東京Vの3バックは相手2トップに対して数的優位を作りやすい。無理に中央へ差し込むのではなく、外CBから両WBへの出口を作りながら、相手1列目のプレスを外して前進したい。",
        result: "pending",
      },
      {
        orderNo: 2,
        title: "2シャドーを千葉の中盤背後へ",
        description:
          "千葉が4-4-2を採用するなら、2列目と最終ラインの間にできるスペースを福田・平尾の2シャドーが使えるかがポイントになる。平川・齋藤との距離を近く保ち、中央で前を向けない場合はシャドーを経由してサイドへ展開する形も狙いたい。",
        result: "pending",
      },
      {
        orderNo: 3,
        title: "両WBの背後を使わせない",
        description:
          "東京Vが両WBを高い位置へ押し上げるほど、ボールを失った直後の背後にはスペースが生まれる。千葉が2トップを置く形なら、最初の縦パスを入れさせず、3バックと中盤のどちらかが素早くカバーできる状態を保ちたい。",
        result: "pending",
      },
    ],
  },
