...
export const matches: Match[] = [
  {
    ...
    verdyProfile: {
      formation: "3-4-2-1",
      characteristics: {
        attack: "3-4-2-1の配置から、前線と両ワイドを使って相手陣へ進む形が直近の公式戦で見られた。",
        defense: "両ワイドの帰陣を含めた5バック化と、中盤の距離感が守備の整理点になる。",
      },
      keyPlayers: [
        { name: "10 森田 晃樹", note: "中盤の配球と前線へのつなぎを担う予想。" },
        { name: "9 染野 唯月", note: "最前線で起点とフィニッシュに関わる予想。" },
      ],
      recentTrend: "直近の公式戦は6月6日のG大阪戦（プレーオフ第2戦）で2-4。8月の新リーグ開幕に向けた編成後の初戦となる。",
    },
    opponentProfile: {
      formation: "4-4-2",
      characteristics: {
        attack: "直近の公式戦では小泉佳穂、久保藤次郎、細谷真大らが関わる前進とフィニッシュが見られた。",
        defense: "4バックと中盤の配置を基準に、前線からの圧力を受けた際のボール保持が観戦上の焦点になる。",
      },
      keyPlayers: [
        { name: "4 古賀 太陽", note: "最終ラインの組み立てと守備の基準点になる予想。" },
        { name: "9 細谷 真大", note: "最前線で背後への動きとフィニッシュを担う予想。" },
      ],
      recentTrend: "直近の公式戦は6月6日の京都戦で0-1。プレーオフ第1戦の6-2勝利を含む公式戦の起用を基準にした予想。",
    },
    predictedLineups: {
      home: {
        formation: "3-4-2-1",
        starters: [
          ...
          { number: 24, name: "仲山 獅恩", position: "FW" },
    ...
    matchNotes: [
      ...
      "両チームは2026年5月3日に対戦し、東京ヴェルディが1-0で勝利した。",
      "柏の直近公式戦では、前線からの圧力を受けた際のボール保持が課題として言及された。",
    ],
    focusPoints: [
      "ヴェルディの両ワイドと柏の4バック外側の攻防",
      "柏の中盤を越える前進と、細谷真大への配球の管理",
    ],
    strategies: [
      {
        orderNo: 1,
        title: "両ワイドの背後取りで前進する",
        description:
          "3-4-2-1の両ワイドと2シャドーの距離を保ち、柏の4バックの外側・背後へ出るタイミングを観戦したい。",
        result: "pending",
      },
      {
        orderNo: 2,
        title: "細谷への前向きな配球を限定する",
        description:
          "柏の中盤から最前線へ入る縦パスに対し、最終ラインだけで受けず中盤からコースを消せるかを見たい。",
        result: "pending",
      },
      {
        orderNo: 3,
        title: "中盤の立ち位置で押し込みを継続する",
        description:
          "攻守の切り替えが増える時間帯に、森田を軸とした中盤の距離感を保ち、セカンドボールを回収できるかに注目したい。",
        result: "pending",
      },
    ],
  },
