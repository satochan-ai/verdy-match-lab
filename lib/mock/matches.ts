...
export const matches: Match[] = [
  {
    ...
    verdyProfile: {
      ...
      keyPlayers: [
        { name: "40 新井 悠太", note: "前線への推進とフィニッシュへの関与が期待される予想。" },
    ...
    focusPoints: [
      "両ワイドと3CB脇を巡るミラー配置での攻防",
      "2シャドー周辺と中盤2枚を経由する前進、細谷真大への配球の管理",
    ],
    strategies: [
      {
        orderNo: 1,
        title: "両ワイドと3CB脇のズレを使う",
        description:
          "同じ3-4-2-1予想の中で、両ワイドと2シャドーが相手の3CB脇へ入るタイミングを観戦したい。",
        result: "pending",
      },
      {
        orderNo: 2,
        ...
        description:
          "柏の2シャドー周辺から最前線へ入る縦パスに対し、中盤2枚がコースを消せるかを見たい。",
        result: "pending",
      },
      {
        orderNo: 3,
        title: "中盤2枚の距離感で押し込みを継続する",
        description:
          "攻守の切り替えが増える時間帯に、中盤2枚と2シャドーの距離感を保ち、セカンドボールを回収できるかに注目したい。",
        result: "pending",
      },
    ],
  },
