export function StickyCta({
  ...
  return (
    <div className="sticky bottom-0 border-t border-border bg-surface px-4 py-3 shadow-[0_-1px_4px_rgba(0,0,0,0.08)] lg:static lg:col-start-1 lg:bg-transparent lg:p-0 lg:shadow-none">
