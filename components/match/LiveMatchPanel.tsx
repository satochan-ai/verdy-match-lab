...
export function LiveMatchPanel({ fixture, teamName }: { fixture: CommonFixture; teamName: string }) {
  ...
  return fixture.detailMatchId ? (
    <Link href={`/${fixture.category}/matches/${fixture.detailMatchId}`} aria-label={`${fixture.opponentName}戦のLIVE詳細を見る`} className="block focus-ring">
      {panel}
    </Link>
  ) : panel;
}
